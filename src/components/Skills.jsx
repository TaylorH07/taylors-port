    ...
    <div name='skills' className='w-full h-screen bg-[#02020c] text-gray-300 '>
      ...
      <div className='max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full '>
        <div>
          ...
          <p className='py-4 '>
            {' '}
            -- These are just a few of the technologies I have worked with:{' '}
          </p>
        </div>
        ...
        <div className='w-full grid grid-cols-2 sm:grid-cols-4 gap-4 text-center py-8 '>
          ...
          <div className='shadow-md shadow-[#040c16] hover:scale-110 duration-500 '>
            <img className='w-32 mx-auto' src={AWS} alt='React icon' />
        ...
        <div className='col-sm-12'>
          <p style={{ textAlign: 'center', fontWeight: 'bold' }}>... but wait there's more!</p>
        </div>
      </div>
    </div>
  );
